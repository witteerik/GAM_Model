Public Class GAM_0_4_Tablet
    ...
    Private Sub GAM_0_4_Tablet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GamSpace12_Paint(sender As Object, e As PaintEventArgs)
